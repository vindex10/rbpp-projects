...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/dcrsc_t.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/dcrsc_cos.eps}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_lowS.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_lowS_contrib.eps}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{visualized/totcrsc_lowS_nomass.eps}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_tail.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_tail_contrib.eps}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_Zpeak.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_Zpeak_contrib.eps}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_Hpeak.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_Hpeak_contrib.eps}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/fbasym.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/fbasym_contrib.eps}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/dcrsc_cos_zprime.eps}}%
    \hfill%
    \subcaptionbox{}{\includegraphics[width=0.49\linewidth]{visualized/totcrsc_zprime.eps}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{visualized/fbasym_zprime.eps}
